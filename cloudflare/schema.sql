...
CREATE TABLE IF NOT EXISTS usage_log (
  ...
  -- charged_amount_usd: USER-FACING CHARGE = (claude+image) * COST_MULTIPLIER.
  --   This is what's actually deducted from user_credits. NOT the sum of the
  --   _cost_usd columns — that trap is why we renamed from "total_cost_usd".
  -- credits_charged: charged_amount_usd expressed in credits (× CREDITS_PER_USD),
