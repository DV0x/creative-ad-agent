...
export const GATE_IO_PROMPT = [
  ...
  '  - founder-facts.md       The brand URL — your LP-congruence check fetches the destination ONCE',
  '                           (WebFetch; if bot-blocked 403/406, retry with page_text before UNVERIFIED).',
  '',
