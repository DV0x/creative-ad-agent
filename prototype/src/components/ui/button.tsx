  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-200 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 aria-invalid:border-destructive active:scale-[0.97] cursor-pointer select-none",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-border bg-bg-raised shadow-xs hover:bg-bg-elevated hover:text-text-primary hover:border-border-emphasis active:bg-bg-overlay",
        secondary:
          "bg-secondary text-secondary-foreground hover:bg-secondary/80 active:bg-secondary/70",
        ghost:
          "hover:bg-bg-elevated hover:text-text-primary active:bg-bg-overlay",
        link: "text-primary underline-offset-4 hover:underline active:scale-100",
        glow:
          "bg-accent text-white font-semibold hover:bg-accent-hover shadow-[0_0_20px_var(--color-accent-glow)] hover:shadow-[0_0_30px_var(--color-accent-glow)] active:shadow-[0_0_15px_var(--color-accent-glow)] focus-visible:shadow-[0_0_40px_var(--color-accent-glow)]",
      },
      size: {
