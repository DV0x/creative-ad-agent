    ...
    <section className="lp-compare-wrap lp-sec" id="shift">
      <div className="lp-wrap">
        <div className="lp-sec-head">
          <div>
            <h2 className="lp-h2">From brief to in-feed, by lunch.</h2>
          </div>
          <div className="right">
            <p>
              Meta and TikTok eat <strong>30+ creatives a month per brand</strong>.
              Hook rate moves when you test new bets — not when you reword the
              old one. <strong>Creative is the targeting now.</strong> The legacy
              loop can't feed that cadence.
            </p>
          </div>
        </div>
        ...
        <div className="lp-compare">
          ...
          <div className="after">
            ...
            <ul className="lp-compare-rows">
              ...
              <li><span className="k">Variant velocity</span><span className="v"><strong>30+ creatives a week.</strong> Concept diversity, not 30 reskins.</span><span className="n">30+</span></li>
